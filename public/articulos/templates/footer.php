...
<footer class="no-imprimir mt-16" style="background:#0F0F1A;">
    <div class="text-white/85 pt-16">
        <div class="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div>
                ...
                <div class="flex flex-col gap-2.5 text-sm">
                    <a href="/#herramientas" class="text-white/70 hover:text-white">IDEA</a>
            ...
            <div>
                ...
                <div class="flex flex-col gap-2.5 text-sm mb-6">
                    <a href="/#icesi-eduteka" class="text-white/70 hover:text-white">Quiénes Somos</a>
                    ...
                    <a href="/#icesi-eduteka" class="text-white/70 hover:text-white">Universidad ICESI</a>
                </div>
...
<button id="btn-volver-arriba" type="button" onclick="window.scrollTo({top:0,behavior:'smooth'})"
        class="no-imprimir hidden fixed bottom-6 left-6 z-40 w-12 h-12 rounded-full bg-white text-marca-azul shadow-lg border border-gray-200 hover:bg-gray-50 transition items-center justify-center text-lg"
